  ...
  return (
    <div className="space-y-2">
      ...
      <select
        ...
        className={`w-full px-4 py-2 bg-slate-700/50 border border-slate-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none ${className}`}
